...
namespace NamedDIRegistrations.Tests
{
    ...
    public class SingletonRegistrationTests
    {
        ...
        public void TestMethod1()
        {
            ...
            collection.AddSingleton<ITestObject>(_ => new TestObjectA());
            collection.AddSingleton<TestObjectB>(_ => new TestObjectB("Hello from Test Object B!"));
        ...
        public void TestMethod2()
        {
            ...
            collection.AddSingleton<ITestObject, TestObjectA>();

            //This doesn't work because there's no default constructor
            //collection.AddSingleton<ITestObject, TestObjectB>();
        ...
        public void TestMethod3()
        {
            ...
            collection.AddNamedSingleton(typeof(ITestObject), typeof(TestObjectA), "NumeroUno");
            Thread.Sleep(1200);
            collection.AddNamedSingleton(typeof(ITestObject), typeof(TestObjectB), "NumeroDos");

            var provider = collection.BuildServiceProvider();

            var registration = provider.GetNamedService(typeof(ITestObject), "NumeroUno");

            Assert.IsInstanceOfType(registration, typeof(ITestObject));

            var secondCall = (ITestObject)provider.GetNamedService(typeof(ITestObject), "NumeroUno");

            Assert.AreEqual(((ITestObject)registration).CreationTimestamp, secondCall.CreationTimestamp);
        ...
        public void TestMethod4()
        {
            ...
            collection.AddNamedSingleton(typeof(ITestObject), _ => new TestObjectA(), "NumeroUno");
            Thread.Sleep(1);
            collection.AddNamedSingleton(typeof(ITestObject), _ => new TestObjectB("Dynamically generated object!"), "NumeroDos");
            ...
            secondCall = (ITestObject) provider.GetNamedService(typeof(ITestObject), "NumeroDos");
